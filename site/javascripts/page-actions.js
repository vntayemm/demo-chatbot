(function () {
  ...
  function initPageActions() {
    ...
    contentInner.classList.add("has-page-actions");
    contentInner.insertAdjacentHTML("afterbegin", renderActions());
    var wrap = contentInner.querySelector(".page-actions-wrap");
    if (wrap) {
      bindActions(wrap);
    }
  }
