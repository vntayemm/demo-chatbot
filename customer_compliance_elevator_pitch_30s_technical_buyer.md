# ELEVATOR PITCH 30 GIAY - TECHNICAL BUYER TONE (CTO/CISO)
...
- **CTO hoi:** "Lam sao dam bao reliability khi tai tang?"  
  **Dap:** "Theo doi SLO latency/error, dung error budget governance, va scale ngang backend theo nguong canh bao."

- **CISO hoi:** "Muc do san sang compliance nhu the nao?"  
  **Dap:** "Da can chinh control intent theo ISO 27001/SOC 2 (access, logging, audit, incident). Co the mo rong sang readiness assessment/chung nhan khi can."

- **CTO/CISO hoi:** "Neu su co nghiem trong?"  
  **Dap:** "Kich hoat runbook P1, co SLA phan hoi, rollback criteria, va RCA bat buoc sau su co de ngan tai dien."
