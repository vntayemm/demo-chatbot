...
- **Rui ro go-live cao**
  - Giai quyet bang `go_live_checklist.md` va rollback criteria ro rang
- **Kho do luong chat luong chatbot**
  - Giai quyet bang `slo_sla.md` (latency, error rate, quality targets)
- **Xu ly su co cham, phan tan**
  - Giai quyet bang `runbook_incident.md` (P1/P2/P3, timeline, ownership)
- **Thieu minh bach rui ro van hanh**
  - Giai quyet bang `risk_register.md` (risk level, warning signs, mitigation)
- **Nghiem thu khong dong nhat**
  - Giai quyet bang `uat_checklist.md` (business criteria + technical criteria)
