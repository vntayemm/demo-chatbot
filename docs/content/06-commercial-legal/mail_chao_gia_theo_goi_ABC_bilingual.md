...
**Subject goi y / Suggested subject:**  
`[Quotation - Package A] Chatbot Foundation for [Company Name]`

**Noi dung mail / Email body:**
...
## 2. Goi B - Professional

**Subject goi y / Suggested subject:**  
`[Quotation - Package B] Chatbot Professional for [Company Name]`
...
Voi muc tieu van hanh chatbot on dinh trong noi bo, ben em de xuat **Goi B - Professional**.  
...
- Bo sung governance va operations docs: risk, SLA/SLO, incident runbook  
  Added governance/operations docs: risk, SLA/SLO, incident runbook
- Benchmark co ban + onboarding team van hanh  
...
## 3. Goi C - Enterprise Readiness

**Subject goi y / Suggested subject:**  
`[Quotation - Package C] Enterprise-Ready Chatbot for [Company Name]`
...
Neu muc tieu la production scale voi governance/reliability cao, ben em de xuat **Goi C - Enterprise Readiness**.  
...
- Hardening production (auth, RBAC baseline, audit logging baseline)  
  Production hardening (auth, RBAC baseline, audit logging baseline)
- Compliance readiness theo control intent ISO 27001/SOC 2  
  Compliance readiness aligned with ISO 27001/SOC 2 control intent
...
- `[Pricing] [Company Name] - Chatbot Governance Package [A/B/C]`
