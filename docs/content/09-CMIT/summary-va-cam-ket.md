...
- Duy trì **mục lục tài liệu** trong `docs/` đồng bộ với thay đổi kiến trúc đáng kể (gateway, service mới, DB mới).  
...
| Trường | Giá trị |
|--------|---------|
| File | `docs/summary-va-cam-ket.md` |
| Cập nhật | Khi thay đổi bộ tài liệu `docs/` chính hoặc mô hình cam kết nội bộ |
