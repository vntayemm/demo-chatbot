...
4. **Runbook** mỗi alert: link tới `docs/` hoặc wiki (restart service, scale worker, kiểm tra integration instance).  
...
| Trường | Giá trị |
|--------|---------|
| File | `docs/gioi-thieu-he-thong-giam-sat-va-canh-bao.md` |
